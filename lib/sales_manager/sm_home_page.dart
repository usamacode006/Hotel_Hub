...
class SMHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: SMHomeNavBar(),
    );
  }
}

class SMHomeNavBar extends StatefulWidget {
  const SMHomeNavBar({Key? key}) : super(key: key);

  @override
  _SMHomeNavBarState createState() => _SMHomeNavBarState();
}

class _SMHomeNavBarState extends State<SMHomeNavBar> {
  @override
  Widget build(BuildContext context) {
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          ...
                          context.read<NavProvider>().SMHomePageNavBar(context);
                        },
