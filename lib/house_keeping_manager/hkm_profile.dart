...
class HKMProfile extends StatefulWidget {
  const HKMProfile({Key? key}) : super(key: key);

  @override
  _HKMProfileState createState() => _HKMProfileState();
}

class _HKMProfileState extends State<HKMProfile> {
  UploadTask? task;
  File? image;
  Timer? _timer;
  int i = 0;
