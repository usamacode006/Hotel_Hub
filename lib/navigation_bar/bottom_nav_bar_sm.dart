...
class BottomNavBarSM extends StatefulWidget {
  const BottomNavBarSM({Key? key}) : super(key: key);

  @override
  _BottomNavBarSMState createState() => _BottomNavBarSMState();
}

class _BottomNavBarSMState extends State<BottomNavBarSM> {
  @override
                ...
                Consumer<NavProvider>(
                  builder: (context, notifier, child) => IconButton(
                      ...
                      onPressed: () {
                        ...
                        context.read<NavProvider>().navToSM(context);
                      }),
                ),
                // Container(
