...
class BottomNavBarFBM extends StatefulWidget {
  const BottomNavBarFBM({Key? key}) : super(key: key);

  @override
  _BottomNavBarFBMState createState() => _BottomNavBarFBMState();
}

class _BottomNavBarFBMState extends State<BottomNavBarFBM> {
  @override
                ...
                Consumer<NavProvider>(
                  builder: (context, notifier, child) => IconButton(
                    ...
                    onPressed: () {
                      ...
                      context.read<NavProvider>().navToFBM(context);
                    },
