...
class BottomNavBarHKM extends StatefulWidget {
  const BottomNavBarHKM({Key? key}) : super(key: key);

  @override
  _BottomNavBarHKMState createState() => _BottomNavBarHKMState();
}

class _BottomNavBarHKMState extends State<BottomNavBarHKM> {
  @override
                ...
                Consumer<NavProvider>(
                  builder: (context, notifier, child) => IconButton(
                    ...
                    onPressed: () {
                      ...
                      context.read<NavProvider>().navToHKM(context);
                    },
