...
class BottomNavBarEM extends StatefulWidget {
  const BottomNavBarEM({Key? key}) : super(key: key);

  @override
  _BottomNavBarEMState createState() => _BottomNavBarEMState();
}

class _BottomNavBarEMState extends State<BottomNavBarEM> {
  @override
                ...
                Consumer<NavProvider>(
                  builder: (context, notifier, child) => IconButton(
                    ...
                    onPressed: () {
                      ...
                      context.read<NavProvider>().navToEM(context);
                    },
