...
class BottomNavBarAGM extends StatefulWidget {
  const BottomNavBarAGM({Key? key}) : super(key: key);

  @override
  _BottomNavBarAGMState createState() => _BottomNavBarAGMState();
}

class _BottomNavBarAGMState extends State<BottomNavBarAGM> {
  @override
                ...
                Consumer<NavProvider>(
                  builder: (context, notifier, child) => IconButton(
                    ...
                    onPressed: () {
                      ...
                      context.read<NavProvider>().navToAGM(context);
                    },
