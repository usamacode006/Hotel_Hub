...
class FBMHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: FBMHomeNavBar(),
    );
  }
}

class FBMHomeNavBar extends StatefulWidget {
  const FBMHomeNavBar({Key? key}) : super(key: key);

  @override
  _FBMHomeNavBarState createState() => _FBMHomeNavBarState();
}

class _FBMHomeNavBarState extends State<FBMHomeNavBar> {
  @override
  Widget build(BuildContext context) {
...
// mainAxisAlignment: MainAxisAlignment.center,
// children: [
// Center(child: Text('Food & Beverage Manager Home Page')),
// ElevatedButton(
// onPressed: () async {
// await FirebaseAuth.instance.signOut();
// Navigator.push(
