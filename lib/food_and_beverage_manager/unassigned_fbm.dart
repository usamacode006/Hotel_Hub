...
import 'package:hotel_hub/navigation_bar/bottom_nav_bar_fbm.dart';
import 'package:hotel_hub/navigation_bar/bottom_nav_bar_gm.dart';

class UnassignedFBM extends StatefulWidget {
  const UnassignedFBM({Key? key}) : super(key: key);

  @override
  _UnassignedFBMState createState() => _UnassignedFBMState();
}

class _UnassignedFBMState extends State<UnassignedFBM> {
  final Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance
      .collection('User')
      .where("Role", isEqualTo: "FBM")
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavBarFBM(),
    );
  }
}
