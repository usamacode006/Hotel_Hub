...
class GmProfile extends StatefulWidget {
  const GmProfile({Key? key}) : super(key: key);

  @override
  _GmProfileState createState() => _GmProfileState();
}

class _GmProfileState extends State<GmProfile> {
  UploadTask? task;
  File? image;
  Timer? _timer;
  int i = 0;
