...
class DeleteGM extends StatefulWidget {
  const DeleteGM({Key? key}) : super(key: key);

  @override
  _DeleteGMState createState() => _DeleteGMState();
}

class _DeleteGMState extends State<DeleteGM> {
