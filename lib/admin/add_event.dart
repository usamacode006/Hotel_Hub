...
class _AddEventState extends State<AddEvent> {
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  if (image == null || eventName.text.trim().isEmpty || eventDescription.text
                    ...
                    uploadToFirebase(
                         eventName.text.trim(), eventDescription.text.trim(),image,date,time);
                  }
                },
  ...
  Future uploadToFirebase( String name, String des,File? img,DateTime date, TimeOfDay time) async {
    if (img == null) {
      return;
    }
