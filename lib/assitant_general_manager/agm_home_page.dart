...
class AGMHomePage extends StatefulWidget {
  const AGMHomePage({Key? key}) : super(key: key);

  @override
  _AGMHomePageState createState() => _AGMHomePageState();
}

class _AGMHomePageState extends State<AGMHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: AGMHomeNavBar(),
    );
  }
}

class AGMHomeNavBar extends StatefulWidget {
  const AGMHomeNavBar({Key? key}) : super(key: key);

  @override
  _AGMHomeNavBarState createState() => _AGMHomeNavBarState();
}

class _AGMHomeNavBarState extends State<AGMHomeNavBar> {
  @override
  Widget build(BuildContext context) {
