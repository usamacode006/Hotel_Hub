...
class AGMProfile extends StatefulWidget {
  const AGMProfile({Key? key}) : super(key: key);

  @override
  _AGMProfileState createState() => _AGMProfileState();
}

class _AGMProfileState extends State<AGMProfile> {
  UploadTask? task;
  File? image;
  Timer? _timer;
  int i = 0;
