...
class DeleteAGM extends StatefulWidget {
  const DeleteAGM({Key? key}) : super(key: key);

  @override
  _DeleteAGMState createState() => _DeleteAGMState();
}

class _DeleteAGMState extends State<DeleteAGM> {
