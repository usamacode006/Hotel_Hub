...
import 'assigned_agm.dart';

class UnassignedAGM extends StatefulWidget {
  const UnassignedAGM({Key? key}) : super(key: key);

  @override
  _UnassignedAGMState createState() => _UnassignedAGMState();
}

class _UnassignedAGMState extends State<UnassignedAGM> {
  final Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance
      .collection('User')
      .where("Role", isEqualTo: "AGM")
